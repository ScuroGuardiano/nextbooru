...
namespace Nextbooru.Core.Migrations
{
    ...
    [Migration("20231230162131_AuthorizationMetadata")]
    partial class AuthorizationMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nextbooru.Auth.Models.AuthorizationMetadata", b =>
                {
                    b.Property<bool>("BuiltinRolesInitialized")
                        .HasColumnType("boolean")
                        .HasColumnName("builtin_roles_initialized");

                    b.ToTable("authorization_metadata", (string)null);
                });

            modelBuilder.Entity("Nextbooru.Auth.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("Nextbooru.Auth.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Nextbooru.Auth.Models.UserPermission", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("Nextbooru.Auth.Models.UserRole", b =>
                {
                    b.Property<string>("RoleName")
                        .HasColumnType("text")
                        .HasColumnName("role_name");
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.Album", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.Image", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.ImageVariant", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.ImageVote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AlbumImage", b =>
                {
                    b.HasOne("Nextbooru.Shared.Models.Album", null)
                        .WithMany()
                    ...
                    b.HasOne("Nextbooru.Shared.Models.Image", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ImageTag", b =>
                {
                    ...
                    b.HasOne("Nextbooru.Shared.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nextbooru.Auth.Models.RolePermission", b =>
                {
                    b.HasOne("Nextbooru.Auth.Models.Role", "Role")
                        .WithMany("Permissions")
                        .HasForeignKey("RoleName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_permissions_roles_role_temp_id");
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.Album", b =>
                {
                    b.HasOne("Nextbooru.Auth.Models.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Nextbooru.Shared.Models.ImageVariant", b =>
                {
                    b.HasOne("Nextbooru.Shared.Models.Image", "Image")
                        .WithMany("Variants")
